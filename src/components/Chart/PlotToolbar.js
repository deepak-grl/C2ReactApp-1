        ...
        return (
            <div className="plot-toggle" style={{ backgroundColor: 'lightgrey', height: '40px' }} >
                ...
                <div className="chart-plottoolbar" data-html2canvas-ignore="true">
                    ...
                    <PlotToolBarButtons tooltip={PLT_LOAD} img={"../../images/chartIcons/PNG/load.png"} clickHandler={this.displayFileDialog.bind(this)} alt={"folder"} separtorClassName={"toolbar-btn-separtor"} buttonId={"chart_toolbar_load_button"} />
                    <div style={{ display: 'none' }} ><input ref={(ref) => { this.refUploadInput = ref; }} type="file" style={{ display: 'none' }} onClick={(e) => e.target.value = null} onChange={this.onFileSelect} /></div>
