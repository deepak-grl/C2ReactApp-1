        ...
        return (
            <div className="panel-setWidth">
                ...
                <div className="help"><img alt="API Guide" src='images/api_48px.png' /><span className="help">C2 API Documentation</span></div> */}
                 <div className="help"><img alt='File' src='images/api_document.png' /><a className="help" id="hpApiDocumentLinkLabel" rel="noopener noreferrer" target="_blank" href='Documentation/index.html' >API Document</a></div>
