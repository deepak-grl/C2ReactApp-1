        ...
        return (
            <div className="panel-setWidth">
                ...
                <div className="help"><img alt="API Guide" src='images/api_48px.png' /><span className="help">C2 API Documentation</span></div> */}
                 <div className="help"><img alt='Email' src='images/api_document.png' /><a className="help" id="hpApiDocumentLinkLabel" rel="noopener noreferrer" href="javascript:void(0);"  >API Document</a></div>
            </div>
        )
    }
}
