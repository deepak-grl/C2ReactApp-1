        ...
        polling(request$, { interval: 1000, backoffStrategy: "exponential", attempts: 4, backgroundPolling: true})
            .subscribe(res => {
                if (res.isValid === true && res.index > mainstore.popUpInputs.popID) {
                    ...
                    if (mainstore.popUpInputs.comboBoxEntries && mainstore.popUpInputs.selectedComboBoxValue === '')
                        mainstore.popUpInputs.selectedComboBoxValue = mainstore.popUpInputs.comboBoxEntries[0];
