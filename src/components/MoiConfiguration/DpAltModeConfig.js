          ...
          <tbody>
            <tr>
              <td className="panellabel">DP Device Type</td>
                ...
                <Dropdown >
                    <Dropdown.Toggle className= "dropdowncustom" variant="success" id="dropdown-basic">{dpconfiginfo.dpAltModeDeviceType}</Dropdown.Toggle>
                  <Dropdown.Menu>
                    {
            ...
            <tr>
              <td className="panellabel">DP Device Capability</td>
                <td className="dropdown-config">
                <Dropdown >
                    <Dropdown.Toggle className= "dropdowncustom" variant="success" id="dropdown-basic">{dpconfiginfo.dpAltModeDeviceCaps }</Dropdown.Toggle>
                  <Dropdown.Menu>
                    {
            ...
            <tr>
              <td className="panellabel">DP Sink Type</td>
                <td className="dropdown-config">
                <Dropdown >
                    <Dropdown.Toggle className= "dropdowncustom" variant="success" id="dropdown-basic">{dpconfiginfo.dpAltModeSinkType }</Dropdown.Toggle>
                  <Dropdown.Menu>
                    {
