...
export const TBTDutVersion = ["TBT_3", "TBT_4"]
...
export const VIF_SUPPORTED_VERSION = "3.1.0.2";
...
export const CREATE_NEW_VIF = `Compliance mode can run tests only with VIF generated from official USB-IF tool, but the currently loaded VIF data was generated by user.
Click Yes, to clear the user loaded VIF data and switch to Compliance mode
Click No, to retain the user loaded VIF data and stay in Informational mode`